...
export default async () => {
    const data: Array<EmojiProps> = await getGitmojis();

    return (
        <FullContent paths={[{ name: 'Git 表情' }]}>
            <div className='bg-gradient-to-br from-gray-900 to-gray-500 w-full lg:h-96 h-48 rounded-t-lg shadow relative p-6 lg:p-16 text-center lg:text-left'>
                <div className="h-full flex flex-col justify-center">
                    ...
                    <div className="relative w-fit mt-6 hidden lg:block">
                        <a href="https://github.com/innev" target="_blank" className="relative p-0.5 inline-flex items-center justify-center font-semibold overflow-hidden group rounded-md" rel='noreferrer'>
