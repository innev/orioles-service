...
const variantStyles = {
  solid: {
    ...
    black: 'bg-black border border-black text-white transition-colors hover:bg-white hover:text-black',
...
export default function Button({ variant = 'solid', color = 'slate', type = 'button', className, href, children, loading = false, ...props}: ButtonProps) {
