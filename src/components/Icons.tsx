export const Location = ({ fill = 'currentColor', size = 1024, ...props }) => {
    return (
...
export const ChevronRightIcon = ({ fill = 'currentColor', size = 24, ...props }) => {
    return (
...
export const CloseIcon = ({ fill = 'currentColor', size = 24, ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg"
            width={size}
            height={size}
            ...
            {...props}
        >
            <path d="m16.192 6.344-4.243 4.242-4.242-4.242-1.414 1.414L10.535 12l-4.242 4.242 1.414 1.414 4.242-4.242 4.243 4.242 1.414-1.414L13.364 12l4.242-4.242z" fill={fill} />
        </svg>
    )
}
...
export const BadgeCheckIcon = ({ fill = 'currentColor', size = 24, ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg"
            width={size}
            height={size}
...
export const TelegramIcon = ({ fill = 'currentColor', size = 24, ...props }) => {
    return (
        <svg
            width={size}
            height={size}
