...
export const RATE_LIMIT_COUNT = process.env.RATE_LIMIT_COUNT || '5';

export const PURCHASE_URL = process.env.NEXT_PUBLIC_PURCHASE_URL

export const PROMPT_SECRET: string = process.env.PROMPT_SECRET || ''
...
export const FADE_DOWN_ANIMATION_VARIANTS = {
    ...
    show: { opacity: 1, y: 1, transition: { type: "spring" } }
};
